...
namespace APIVerve
{
    public class WebsiteImagesScraperAPIClient
    {
        ...
        public WebsiteImagesScraperAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public WebsiteImagesScraperAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
